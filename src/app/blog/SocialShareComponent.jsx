...
const SocialShareComponent = ({ shareURL }) => {
    ...
    return (
        <div className="cursor-pointer relative" onClick={handleShareClick}>
            <svg
                width="25px"
                height="25px"
                viewBox="0 0 15 15"
            ...
            {isOpen && (
                <div
                    ref={modalRef}
                    className="absolute top-10 left-0 bg-white dark:bg-gray-500 dark:text-white text-black p-2 rounded-lg shadow-lg"
                >
