        ...
        <section className="renaissance-hero">
            ...
            <div className="renaissance-grid">
                ...
                <div>
                    ...
                    {/* CTAs */}
                    <div className="renaissance-fade-up renaissance-fade-up-delay-3 renaissance-cta-row flex flex-wrap gap-4">
                ...
                <div className="renaissance-portrait-wrapper renaissance-fade-in">
                    <div className="renaissance-portrait-float">
                        ...
                        {/* Corner flourishes */}
                        <div className="renaissance-flourish renaissance-flourish--tl">
                            <CornerFlourish />
                        </div>
                        <div className="renaissance-flourish renaissance-flourish--tr">
                            <CornerFlourish />
                        </div>
                        <div className="renaissance-flourish renaissance-flourish--bl">
                            <CornerFlourish />
                        </div>
                        <div className="renaissance-flourish renaissance-flourish--br">
                            <CornerFlourish />
                        </div>
                    </div>
                </div>
